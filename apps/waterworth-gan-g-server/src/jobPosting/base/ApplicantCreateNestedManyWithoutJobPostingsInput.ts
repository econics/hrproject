...
@InputType()
class ApplicantCreateNestedManyWithoutJobPostingsInput {
...
export { ApplicantCreateNestedManyWithoutJobPostingsInput as ApplicantCreateNestedManyWithoutJobPostingsInput };
