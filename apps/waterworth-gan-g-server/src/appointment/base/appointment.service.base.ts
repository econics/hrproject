...
import { BookAppointmentInput } from "../BookAppointmentInput";
...
export class AppointmentServiceBase {
  ...
  async BookAppointment(args: BookAppointmentInput): Promise<AppointmentDto> {
    throw new Error("Not implemented");
  }
  async GetAppointments(args: AppointmentDto): Promise<AppointmentDto[]> {
    throw new Error("Not implemented");
  }
}
