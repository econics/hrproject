          ...
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Keep track of your remaining leaves
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 rounded-lg border p-4">
                    <StethoscopeIcon className="h-6 w-6 text-muted-foreground" />
              ...
              <CardContent>
                <div className="flex flex-col gap-4">
                  <div className="grid grid-cols-[25px_1fr] items-start gap-4">
                    ...
                    <div>
                      <p className="font-medium">New HR Policy</p>
                      <p className="text-sm text-muted-foreground">
                        The company has updated its HR policy. Please review the
                        changes.
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-[25px_1fr] items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        The office will be closed on May 1st for Labor Day.
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-[25px_1fr] items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Congratulations to Jane Smith for being the Employee of
                        the Month!
                      </p>
                    </div>
                  </div>
